...
[${green}04${NC}]${color1} •${color3}$bd shadowsocks (${color2}add-ss${color3})
[${green}05${NC}]${color1} •${color3}$bd  del user (${color2}delete-ss${color3})
[${green}06${NC}]${color1} •${color3}$bd cek user (${color2}cek${color3})
[${green}07${NC}]${color1} •${color3}$bd  renew user (${color2}renew${color3})
[${green}08${NC}]${color1} •${color3}$bd cek usage (${color2}usage${color3})
[${green}09${NC}]${color1} •${color3}$bd add custom domain + cert (${color2}addhost-cert${color3})

[${green}00${NC}]${color1} •${color3}$bd Back to exit Menu \033[1;32m<\033[1;33m<\033[1;31m<\033[1;31m"
echo ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "\E[44;1;39m                     ⇱ FSID VPN PROJECT ⇲                       \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e  ""
...
9 | 09) clear ; read -p "Input Your Domain : " domain
if [[ $domain == "" ]]; then
    clear
